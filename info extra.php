...
if ($resultado_grupo->num_rows > 0) {
    ...
    $sql = "SELECT * FROM posts WHERE categoria = 'info-extra'";
...
<body class="d-flex flex-column h-100">
    ...
    <h3 class="text-start" style="color: white;">Información Extra</h3>
    ...
    <div class="card-header" style="background-color: #212529; color: #ffffff;">Sección de Información Extra de Los Santos V</div>
    <div class="card-body">
        <?php
    ...
    <i class="fa fa-underline"></i>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="categoria" name="categoria" required>
                                    <option value="info-extra">Información Extra</option>
